        ...
        <div className="containerb">
          ...
          <div className="search">
            <div className="searchbox">
              ...
              <input type="text" name="from" value={sendData.from} onChange={changeData} placeholder="Search for starting point..." />
            </div>
            <div className="searchbox">
              <label htmlFor="To">To</label>
              <input type="text" name="to" value={sendData.to} onChange={changeData} placeholder="Enter your ending point..." />
            </div>
            <div className="searchbox">
              <label htmlFor="date">Date</label>
              <input type="date" name="date" value={sendData.date} onChange={changeData} />
            </div>
            <div className="searchbox">
              <button type="submit"  onClick={sendDataForBooking}>Booking Flight</button>
            </div>
          </div>
        </div>
      </div>
